...
def xy_round(data,x0,y0,skymode,ker2d,xsigsq,ysigsq,datamin=None,datamax=None):
    ...
    xy_val = drizzlepac.cdriz.arrxyround(data,x0,y0,skymode,ker2d,xsigsq,ysigsq,datamin,datamax)
    if xy_val is None:
        x = None
        y = None
        round = None
...
def centroid(im):
    ...
    """
    # These calls point to Python version of moments function
    m00 = drizzlepac.cdriz.arrmoments(im,0,0)
    m10 = drizzlepac.cdriz.arrmoments(im, 1,0)
    m01 = drizzlepac.cdriz.arrmoments(im,0,1)
