...
def build_svm_plots(data_source, output_basename=''):
    ...
    gaia_data_cols = HOVER_COLUMNS + ['distribution_characterization_statistics.Number_of_GAIA_sources',
    ...
    gaia_cols = get_pandas_data(data_source, gaia_data_cols)

    gaia_plots = build_gaia_plots(gaia_cols, gaia_data_cols, 
...
#    
def build_gaia_plots(gaia_data, data_cols, output_basename='svm_qa'):
