...
# These columns are part of the output dataframe, and consequently the column data
# source object for free
DATA_COLUMNS = ['gen_info.instrument',
                'gen_info.detector',
                'gen_info.filter',
                'gen_info.imgname',
                'header.DATE-OBS',
...
def build_crossmatch_plots(xmatchCDS, data_cols, output_basename='svm_qa'):
    ...
    num_hover_cols = len(DATA_COLUMNS)
