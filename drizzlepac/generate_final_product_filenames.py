...
def interpret_obset_input(results):
    ...
    obset_table = Table.read(results, format='ascii.fast_no_header')
    # label each column with a descriptive name
    for col, cname in zip(obset_table.colnames, colnames):
        obset_table[col].name = cname
...
def single_exposure_product_filename_generator(obs_info, sep_num):
    """
    ...
    product_filename_dict["image"] = "hst_{}_{}_{}_{}_{}_{}_{}.fits".format(obs_info[0], obs_info[1],
                                                                            obs_info[2], obs_info[3],
                                                                            obs_info[4], obs_info[5], sep_num)
...
def filter_product_filename_generator(obs_info, fp_num):
    """
    ...
    product_filename_dict = {}
    product_filename_dict["image"] = "hst_{}_{}_{}_{}_{}.fits".format(obs_info[0], obs_info[1],
                                                                      obs_info[2], obs_info[3],
                                                                      obs_info[4])
    product_filename_dict["source catalog"] = product_filename_dict["image"].replace(".fits", ".cat")
...
def total_detection_product_filename_generator(obs_info, tdp):
    """
    ...
    product_filename_dict = {}
    product_filename_dict["image"] = "hst_{}_{}_{}_{}.fits".format(obs_info[0], obs_info[1],
                                                                   obs_info[2], obs_info[3])
    product_filename_dict["source catalog"] = product_filename_dict["image"].replace(".fits", ".cat")
...
def multivisit_mosaic_product_filename_generator(obs_info, mvp_num):
    """
    ...
    product_filename_dict = {}
    product_filename_dict["image"] = "hst_mos_{}_{}_{}_{}.fits".format(obs_info[0], obs_info[1],
                                                                       obs_info[2], obs_info[3])
    product_filename_dict["source catalog"] = product_filename_dict["image"].replace(".fits", ".cat")
