...
class HapDiagnostic(object):
    def __init__(self, prop_id, obset_id, telescope, instrument, detector, filter, data_source, description,
        ...
        # TODO: Add header info: seconds since the epoch

        # TODO: add header info: target name
        # TODO: add header info: target description/category
        # TODO: add header info: exposure time (or total exposure time for drizzle product)
        # TODO: add header info: image type (spectroscopic vs image/accum)
        # TODO: add header info: value of MTFLAG keyword
