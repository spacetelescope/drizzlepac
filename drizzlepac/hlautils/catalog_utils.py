...
class HAPCatalogBase:
    ...
    def annotate_table(self, data_table, product="tdp"):
        ...
        data_table.meta["h12"] = ["RA and Dec values, are sky coordinates i.e. coordinates at the epoch of observation"]
        data_table.meta["h12.1"] = [" and fit to GAIADR1 (2015.0) or GAIADR2 (2015.5)".]
        data_table.meta["h13"]  = ["Magnitude values are in the ABMAG system"]
