...
def build_wcscat(image, group_id, source_catalog):
    """ Return a list of `~tweakwcs.tpwcs.FITSWCS` objects for all chips in an
    image.
    ...
    wcs_catalogs : list of tweakwcs.tpwcs.FITSWCS
        List of `~tweakwcs.tpwcs.FITSWCS` defined for all chips in input image.
    ...
    if isinstance(image, str):
        ...
        print("Wrong type of input, {}, for build_wcscat...".format(type(image)))
        raise ValueError
