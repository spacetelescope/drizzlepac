...
from ..helpers import BaseWFC3, raw_from_asn
...
class TestWFC3(BaseWFC3):
    ...
    def test_binned_single(self):
        ...
        # Prepare input files.
        input_file = os.path.basename(self.get_data('input', input_name))
    ...
    def test_uvis_asn(self):
        ...
        for raw_file in raw_from_asn(asn_file, suffix='_flt.fits'):
            input_files.append(os.path.basename(self.get_data('input', raw_file)))
