...
class TestVaryPerf(BaseWFC3):
    ...
    def test_perf(self, output, in_memory, num_cores, use_static, skywidth):
        ...
        input_pars = {"build": True, "preserve": False, "clean": True, "sky_bits": None}
